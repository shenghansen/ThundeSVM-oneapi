...
namespace svm_kernel {
    ...
    void
    get_working_set_ins_col(const SyncArray<kernel_type> &val, const SyncArray<int> &col_ind, const SyncArray<int> &row_ptr,
                            const SyncArray<int> &data_row_idx, SyncArray<kernel_type> &data_rows, int m, int n);
...
#ifndef USE_CUDA//如果没有定义USE_CUDA，就调用自己编写的这两个函数
